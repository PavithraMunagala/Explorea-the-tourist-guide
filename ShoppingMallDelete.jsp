...
<%
    ...
    if (ShoppingMallsName == null || ShoppingMallsName.trim().isEmpty()) {
        ...
        try {
            ...
            String sql = "DELETE FROM shoppingmalls WHERE ShoppingMallsName = ?";
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, ShoppingMallsName);

            int rowsAffected = pstmt.executeUpdate();
            if (rowsAffected > 0) {
                response.sendRedirect("ShoppingMalls.jsp"); // Redirect back to the hotels list
            } else {
