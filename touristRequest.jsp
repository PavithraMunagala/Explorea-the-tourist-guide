...
try {
    ...
    rs = stmt.executeQuery("SELECT * FROM touristspotsuggestion LIMIT 50"); // Adjust to get only 20 records
...
%>
   <div class="hotel-item">
    <h3 class="hotel-name"><%=Tourist_Spot  %></h3>
    <p class="hotel-address"><%= Address %></p>
    <p class="hotel-address"><%= AdditionalInfo %></p>
    <div class="hotel-actions">
    <!-- Accept button form -->
    <form action="TouristAccept.jsp" method="post" style="display:inline;">
    ...
    <form action="TouristDecline.jsp" method="post" style="display:inline;">
        <input type="hidden" name="Tourist_Spot" value="<%= Tourist_Spot %>">
