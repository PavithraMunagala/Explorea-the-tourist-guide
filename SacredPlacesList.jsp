...
try {
    ...
    while (rs.next()) {
        String sacredplace = rs.getString("sacredplaces");
        String address = rs.getString("address");
%>
   <div class="hotel-item">
    <h3 class="hotel-name"><%= sacredplace %></h3>
    ...
    <div class="hotel-actions">
        ...
        <form action="SacredPlacesDelete.jsp" method="post" style="display:inline;">
            <input type="hidden" name="sacredplaces" value="<%=sacredplace %>">
