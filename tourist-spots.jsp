...
<head>
  ...
  <style>
    ...
    * {
    ...
    body {
      background-image: url(Images/tourist-spots.jpg);
...
<body>
  ...
  <div class="sidebar">
    ...
    <button onclick="TouristSuggestion()">Suggest Tourist Spot</button>
  </div>
  ...
  <form class="modal-content animate" action="TValidate.jsp" method="post">
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <p style="margin-top: 20px;">Don't have account? <b><a href="TRegister.html">Register</a></b></p>
      </div>
    </div>
  </form>
</div>
    ...
    <script>
        ...
        function TouristSuggestion() {
            window.location.href = "TouristSuggest.html";
        }
    </script>
