...
<body>
    <div class="form-container">
       <h1>Enter Tourist Spot Details</h1>
<form action="TouristInputSubmission.jsp" method="post">
    <label for="Spotname">Spot Name: </label>
    <input type="text" name="Tourist_Spot" placeholder="Enter Spot name" required>
