...
<%
    ...
    String sql = "INSERT INTO TFeedback (feedback) VALUES (?)";
    pstmt = conn.prepareStatement(sql);
    pstmt.setString(1, feedback);
    int rowsAffected = pstmt.executeUpdate();
        if (rowsAffected > 0) {
            response.sendRedirect("tourist-spots.jsp");//response.sendRedirect("SacredPlaces.jsp"); // Redirect to success page
        } else {
