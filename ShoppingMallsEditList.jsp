...
<body>
    ...
    <h2>Explore Our Shoppingmalls</h2>
...
try {
    ...
    rs = stmt.executeQuery("SELECT * FROM shoppingmalls LIMIT 20"); // Adjust to get only 20 records
...
<div class="hotel-item">
    <h3 class="ShoppingMalls-name"><%=ShoppingMallsName %></h3>
    ...
    <div class="hotel-actions">
        ...
        <form action="ShoppingMallsEdit.jsp" method="post" style="display:inline;">
...
<%
    ...
    out.println("Unable to load hotel information at the moment. Error: " + e.getMessage());
    e.printStackTrace();
} finally {
