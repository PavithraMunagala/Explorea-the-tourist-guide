...
<body>
    <div class="form-container">
        <h1>Enter Sacred Place Details</h1>
        <form action="sacredplaceInputSubmission.jsp" method="post">
            <label for="sacredplaces">Sacred Place:</label>
            <input type="text" id="sacredplaces" name="sacredplaces" placeholder="Enter sacred place" required>
