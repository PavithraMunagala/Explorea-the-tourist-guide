...
<head>
    ...
    <title>sacred places List</title>
    <style>
...
<body>
    ...
    <h2>Explore Our Shopping Malls</h2>
...
%>
   <div class="hotel-item">
    ...
    <div class="hotel-actions">
        ...
        <!-- Delete button with hidden HotelName input -->
        <form action="ShoppingMallDelete.jsp" method="post" style="display:inline;">
...
<%
    ...
    out.println("Unable to load Sacred Place information at the moment. Error: " + e.getMessage());
    e.printStackTrace();
} finally {
