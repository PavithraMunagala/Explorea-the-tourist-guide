...
<body>
  ...
  <div class="sidebar">
    ...
    <button onclick="HotelSuggestion()">Suggest More</button>
  </div>
  ...
  <div class="main-content">
    ...
    <div class="bottom-content">
      <h2 style="font-size: 50px; margin-bottom: 10px;">Explore Hotels</h2>
      <%
      Connection con = null;
      Statement stmt = null;
      ResultSet rs = null;
      try {
          ...
          rs = stmt.executeQuery("SELECT * FROM Hotel LIMIT 50"); // Adjust to get only 20 records
  ...
  <form class="modal-content animate" action="HValidate.jsp" method="post">
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <p style="margin-top: 20px;">Don't have account? <b><a href="HRegister.html">Register</a></b></p>
      </div>
    </div>
  </form>
</div>
    ...
    <script>
        ...
        function HotelSuggestion() {
            window.location.href = "HotelSuggest.html";
        }
    </script>
