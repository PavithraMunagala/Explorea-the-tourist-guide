...
if (HotelName != null) {
    ...
    try {
        ...
        // Delete query
        String query = "DELETE FROM hotelsuggestions WHERE HotelName = ?";
        pstmt = con.prepareStatement(query);
        pstmt.setString(1, HotelName);
        int rows = pstmt.executeUpdate();

        if (rows > 0) {
            out.println("<script>alert('Tourist spot declined and removed from suggestions!'); window.location.href='hotelRequest.jsp';</script>");
        } else {
