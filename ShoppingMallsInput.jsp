...
<body>
    <div class="form-container">
       <h1>Enter ShoppingMalls Details</h1>
<form action="ShoppingMallsInputSubmission.jsp" method="post">
    <label for="ShoppingMallsName">ShoppingMallsName: </label>
    <input type="text" name="ShoppingMallsName" placeholder="Enter ShoppingMallsName" required>
