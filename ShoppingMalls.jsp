...
<head>
  ...
  <style>
    ...
    * {
    ...
    body {
      background-image: url(Images/shoppingg.png);
...
<body>
      ...
      <ul class="nav-links">
        <!-- Navigation Links as per the original code -->
         ...
         <li class="dropdown" style="color: #121111;">Explore
          ...
          <li><a href="ShoppingMall.jsp">Shopping</a></li>
          </ul>
        </li>
  ...
  <div class="sidebar">
    <h2>Explore Shopping malls</h2>
    <button onclick="TouristSuggestion()">Suggest Shopping Malls</button>
  </div>
  ...
  <div class="main-content">
    ...
    <div class="bottom-content">
      <h2 style="font-size: 50px; margin-bottom: 10px;">Explore Shopping malls</h2>
      <%
      Connection con = null;
      Statement stmt = null;
      ResultSet rs = null;
      try {
          ...
          rs = stmt.executeQuery("SELECT * FROM ShoppingMalls LIMIT 50"); // Adjust to get only 20 records
  ...
  <form class="modal-content animate" action="SValidate.jsp" method="post">
    ...
    <div class="container" style="background-color:#f1f1f1">
      ...
      <p style="margin-top: 20px;">Don't have account? <b><a href="SRegister.html">Register</a></b></p>
      </div>
    </div>
  </form>
</div>
 ...
 var modal = document.getElementById('id01');
        ...
        function TouristSuggestion() {
            window.location.href = "ShoppingMallsSuggest.html";
        }
    </script>
