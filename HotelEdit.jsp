...
<%
    String originalHotelName = request.getParameter("HotelName");
    String newHotelName = originalHotelName;
    ...
    if (originalHotelName == null || originalHotelName.trim().isEmpty()) {
        out.println("<h2>Error:Hotel name is required.</h2>");
    } else {
        try {
            ...
            pstmt.setString(1, originalHotelName);
...
<body>
    <div class="form-container">
        ...
        <form action="UpdateHotel.jsp" method="post">
            <input type="hidden" name="OriginalHotelName" value="<%= originalHotelName %>">
            
            <label for="newHotelName">Hotel Name:</label>
            <input type="text" id="newHotelName" name="NewHotelName" value="<%= newHotelName %>">
